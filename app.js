...
async function getAccessToken() {
    try {
        ...
        const response = await fetch("https://thingproxy.freeboard.io/fetch/https://saas.castbox.fm/auth/api/v1/tokens/provider/secret", {
            method: 'POST',
            headers: {
...
async function fetchAvailableModels() {
    try {
        ...
        const response = await fetch("https://thingproxy.freeboard.io/fetch/https://ai-seek.thebetter.ai/v1/chat/list_models", {
             method: 'GET',
             headers: {
...
async function sendMessage(message) {
    ...
    try {
        ...
        const response = await fetch("https://thingproxy.freeboard.io/fetch/https://ai-seek.thebetter.ai/v3/chat/send", {
             method: 'POST',
